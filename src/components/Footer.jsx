  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <Link to="/" style={{ textDecoration: 'none', cursor: 'none' }}>
          <div style={{ 
        ...
        {/* Links Container - INSIGHTS REMOVED */}
        <div style={{
          display: 'flex',
          gap: '80px',
          flexWrap: 'wrap'
          ...
          <div style={linkColumnStyle}>
            ...
            <MotionLink to="/services" whileHover={{ color: '#ffffff', x: 4 }} style={linkStyle}>Services</MotionLink>
            <MotionLink to="/products" whileHover={{ color: '#ffffff', x: 4 }} style={linkStyle}>Instruments</MotionLink>
          </div>

          {/* Column 2 */}
          <div style={linkColumnStyle}>
            <div style={headerStyle}>Company</div>
            <MotionLink to="/about" whileHover={{ color: '#ffffff', x: 4 }} style={linkStyle}>About Us</MotionLink>
            <MotionLink to="/contact" whileHover={{ color: '#ffffff', x: 4 }} style={linkStyle}>Contact</MotionLink>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <motion.div
            onClick={scrollToTop}
            whileHover={{ backgroundColor: '#1ea950' }}
            style={{
              width: '40px',
              height: '40px',
